"""
Day 1 Challenge: Age-Based Ticket Pricing System Problem Statement Create a system to determine the ticket price based on the visitor's age, the time of visit, and VIP membership status.
...
tprice = 1000
time = int(input("Coming time: "))
vip = input("VIP member (yes or no): ").strip().lower()

# Base price after age-based discounts
if age < 5:
    final_price = 0
elif age < 12:
